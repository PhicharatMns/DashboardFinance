...
import DataETF from "../../data/dataETF";
      ...
      script.innerHTML = `
        {
          ...
          "symbols": ["${event.ID}|${selectdateRanges}"],
          "dateRanges": [
            "1d|1",
            "1m|30",
            "3m|60",
      ...
      <div className="text-center p-5">
        {Object.entries(dateRanges).map(([name, value]) => (
          <button
            ...
            className={`px-4 rounded-full text-sm font-semibold transition-colors duration-200 p-1 cursor-pointer 
  ${
